...
local Window = Library.CreateLib("Easy Hub ()", getgenv().Theme) 
...
Section:NewToggle("Speed", "Speed 90 jumpower 100", function(state)
    if state then
...
----this where u cant get kick made by sm1
